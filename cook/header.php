...
<img src="/img/core-img/favicon.ico" width="32" height="22">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text" data-i18n="Components">Management</span>
    </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="add-recipe.php" class="menu-link">
            <div data-i18n="Add">Add</div>
          </a>
        </li>
        <li class="menu-item">
                ...
                <a class="dropdown-item" href="pages-account-settings-account.html">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-medium d-block"><?= $loader->user['name'] ?></span>
